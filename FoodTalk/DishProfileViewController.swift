...
class DishProfileViewController: UIViewController, iCarouselDataSource, iCarouselDelegate, WebServiceCallingDelegate, UIActionSheetDelegate, TTTAttributedLabelDelegate {
    ...
    override func viewDidLoad() {
        ...
        if(comingFrom.isEqual("HomeDish")){
            ...
            for(var index : Int = 0; index < arrDishList.count; index++){
